...
class I18n implements ArrayAccess
{
	...
	{
		return str_starts_with($key, 'i18n:');
	}
	 ...
	 * @return string
	 */
	public function translate(string $key, array $insertVariables = array()): string|false
	{
		// If the key starts with 'i18n:', remove it
		if (str_starts_with($key, 'i18n:')) {
			$key = substr($key, 5);
		}
	...
	{
		return $this->translate(key: $offset) ?? false;
	}
